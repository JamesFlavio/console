...
//Dados da NFe - infNFe
$selectNotas= "	SELECT *, ci.nome as cidade FROM notas AS n
				JOIN cadastros AS ca 	ON ca.id = n.cadastros_id
				JOIN ceps AS ce 		ON ce.cep = ca.ceps_cep
				JOIN cidades AS ci 		ON ci.ibge = ce.cidades_ibge
				WHERE n.id = '3'
			  ;";
$queryNotas	= mysqli_query($conexaoMysql,$selectNotas);

$rowsNotas	= mysqli_fetch_assoc($queryNotas);

$cUF 		= $rowsNotas['cUF']; 		// '52'					//codigo numerico do estado
$cNF 		= $rowsNotas['cNF']; 		// '00000010'			//numero aleatório da NF
$natOp		= $rowsNotas['natOp'];		// 'Venda de Produto'	//natureza da operação
$indPag 	= $rowsNotas['indPag']; 	// '1' 					//0=Pagamento à vista; 1=Pagamento a prazo; 2=Outros
$mod		= $rowsNotas['mod']; 		// '55' 				//modelo da NFe 55 ou 65 essa última NFCe
$serie		= $rowsNotas['serie'];		// '1'					//serie da NFe
$nNF		= $rowsNotas['nNF']; 		// '10'					// numero da NFe
...
$tpNF 		= '1';
$idDest 	= $rowsNotas['idDest'];		// '1' 					//1=Operação interna; 2=Operação interestadual; 3=Operação com exterior.
$cMunFG 	= $rowsNotas['cMunFG'];		// '5200258'
...
$xLgr	= 'SIA Trecho 07 Lote 100 Conj E Sala 138';	// 'Av. Rio de Janeiro'
$nro	= 'S/N';		// 's/n'
$xCpl	= 'FECAB';		// 'Qd. 38 Lt. 4,5 e 34'
$xBairro= 'SIA';		// 'Jardim Pinheiros I'
$cMun	= '5300108';	// '5200258'
$xMun	= 'Brasília';	// 'Águas Lindas de Goiás'
$UF		= 'DF';			// 'GO'
$CEP	= '71208900';	// '72910000'
$cPais	= '1058';		// '1058'
$xPais	= 'Brasil';		// 'Brasil'
$fone	= '6130466866';	// '6239324097'
$resp	= $nfe->tagenderEmit($xLgr, $nro, $xCpl, $xBairro, $cMun, $xMun, $UF, $CEP, $cPais, $xPais, $fone);

//destinatário
$CNPJ			= $rowsNotas['cnpj_ou_cpf']; 			// '23401454000170'
$CPF			= '';									// ''
$idEstrangeiro	= '';									// ''
$xNome			= $rowsNotas['razao_social_ou_nome'];	// 'Chinnon Santos - Tecnologia e Assessoria em Softwares'
$indIEDest		= '1';			// '1'					// "1": Contribuinte de ICMS. Neste caso, deverá ser informada a Inscrição Estadual do destinatário.
														// "2": Contribuinte isento. 
														// "9": Não Contribuinte, que pode ou não possuir Inscrição Estadual no Cadastro de Contribuintes do ICMS.
$IE				= $rowsNotas['ie_ou_rg'];				// ''
$ISUF			= '';									// ''
$IM				= $rowsNotas['im'];						// '4128095'
$email			= 'contato@emporioautomacao.com.br';// 'nfe@chinnonsantos.com'
$resp = $nfe->tagdest($CNPJ, $CPF, $idEstrangeiro, $xNome, $indIEDest, $IE, $ISUF, $IM, $email);

//Endereço do destinatário
$xLgr	= $rowsNotas['endereco']; 		// 'Av. Vila Alpes';
$nro	= $rowsNotas['numero']; 		// 's/n';
$xCpl	= $rowsNotas['complemento']; 	// '';
$xBairro= $rowsNotas['bairro'];			// 'Vila Alpes';
$cMun	= $rowsNotas['cidades_ibge']; 	// '5208707';
$xMun	= $rowsNotas['cidade']; 		// 'Goiânia';
$UF		= $rowsNotas['estados_uf']; 	// 'GO';
$CEP	= $rowsNotas['ceps_cep']; 	// '74310010';
$cPais	= '1058';		 		// '1058';
$xPais	= 'Brasil'; 			// 'Brasil';
$fone 	= $rowsNotas['telefones']; 	// '6292779404';
...
$aP[] = array(
        ...
        'indTot'	=> '1',
        'xPed'		=> '',
        'nItemPed'	=> '', // cho que é o código de fabrica
        'nFCI'		=> '');
//produtos 2
$aP[] = array(
        'nItem'		=> 2,
        'cProd'		=> '16',
        'cEAN'		=> '97899072659522',
        'xProd' 	=> 'Chopp Heineken - Barril 30 Lts',
        'NCM'		=> '22030000',
        'EXTIPI'	=> '',
        'CFOP'		=> '5102',
        'uCom'		=> 'Un',
...
$nItem		= 1; //produtos 1
$cst		= '99'; //Operação Tributável (base de cálculo = quantidade vendida x alíquota por unidade de produto)
$vBC		= '0.00';
$pPIS		= '0.00';
$vPIS		= '0.00';
$qBCProd	= '';
...
$nItem		= 2; //produtos 2
$cst		= '99'; //Operação Tributável (base de cálculo = (valor da operação * alíquota normal) / 100
$vBC		= '0.00';
$pPIS		= '0.00';
$vPIS		= '0.00';
$qBCProd	= '';
